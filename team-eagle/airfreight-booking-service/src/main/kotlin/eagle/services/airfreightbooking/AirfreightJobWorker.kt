package eagle.services.airfreightbooking
...
class AirfreightJobWorker {
        ...
        override fun handle(client: JobClient, job: ActivatedJob) {
            ...
            if (shouldFail()) {
                ...
                client.newFailCommand(job.key)
                        ...
                        .errorMessage("Simulated Failure on Airfreight Booking")
                        .send().join()
            } else {
    ...
    companion object {
        private val LOGGER = LoggerFactory.getLogger(AirfreightJobWorker.javaClass)
    }
}